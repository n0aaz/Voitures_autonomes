...
individus=lecture_generation('generation')
print(individus)
for individu in individus:
	individu.position=position_initiale
	individu.vivant=True
individus,distances,plot=generation(individus[:40],False)
nbgen=30
drap=False
liste_dist=[]
liste_var=[]
